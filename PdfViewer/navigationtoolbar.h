...
public:
    NavigationToolBar(fz_context *ctx, QWidget *parent = nullptr);
...
Q_SIGNALS:
    void sigZoomChanged(qreal value); // NOLINT(readability-inconsistent-declaration-parameter-name)
    void sigRotationChanged(int rotation); // NOLINT(readability-inconsistent-declaration-parameter-name)
...
private Q_SLOTS:
    ...
    void onRotationComboChanged(int idx);
